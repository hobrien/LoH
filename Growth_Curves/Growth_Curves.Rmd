...
```
```{r}
Ca_301216 <- mutate(Ca_301216, Row = substr(Well, 1, 1), Column = substr(Well, 2, nchar(Well)))
Ca_301216_fit <- mutate(Ca_301216_fit, Row = substr(Well, 1, 1), Column = substr(Well, 2, nchar(Well)))
