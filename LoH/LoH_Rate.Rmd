...
`r margin_note("- plotted are percentages of different LoH events on Chr1 (HCM1) and Chr4(AXL2)")`
...
`r margin_note("- plotted are MICs and BBGs for 24 strains per category")`
`r margin_note("- strains marked on Chr1(HCM1)")`
...
`r margin_note("- strains marked on Chr4(AXL2)")`
