...
It appears that Hsp90 activity is relevant for LoH rather than Hsp90 levels. Increasing temperatures result in increased LoH rates. It is assumed that at higher than normal temperatures, Hsp90 is tied up in stabilizing proteins and the pool of available Hsp90 is reduced. Combining that with Hsp90 inhibition, results in even higher LoH rates, suggesting that Hsp90 activity is reduced to a minimum.
